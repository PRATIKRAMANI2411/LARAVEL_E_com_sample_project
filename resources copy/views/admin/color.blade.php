            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($list->status==1)
                            <a href="{{url('admin/color/status/0')}}/{{$list->id}}"><button class="btn btn-outline-info" type="submit">Activ</button></a>
                        @elseif($list->status==0)
                            <a href="{{url('admin/color/status/1')}}/{{$list->id}}"><button class="btn btn-outline-secondary" type="submit">Deactiv</button></a>
                        @endif
                        </td>
                        <td class="text-center">
