...
<head>
    ...
    <script src="https://kit.fontawesome.com/8fab4ca275.js" crossorigin="anonymous"></script>
    <!-- Fontfaces CSS-->
    <link href="{{asset('admin_assets/vendor/font-awesome-4.7/c<script src="https://kit.fontawesome.com/8fab4ca275.js" crossorigin="anonymous"></script>ss/font-awesome.min.css')}}" rel="stylesheet" media="all">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="@yield('coupon_select')">
                            <a class="#" href="{{url('admin/coupon')}}">
                                <i class="fas fa-tag"></i></i>Coupon</a>
                        </li>
                        ...
                        <li class="@yield('brand_select')">
                            <a class="#" href="{{url('admin/brand')}}">
                                <i class="fa-brands fa-product-hunt"></i>Brand</a>
                        </li>
