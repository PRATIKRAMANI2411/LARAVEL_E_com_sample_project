...
@section('container')
    ...
    <a href="tax/manage_tax">
        <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Add Tax</button>
    </a>
        ...
        <div class="table-responsive m-b-40">
            <table class="table table-borderless table-data3">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th class="text-center">tax dis</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @if($list->status==1)
                            <a href="{{url('admin/tax/status/0')}}/{{$list->id}}"><button class="btn btn-outline-info" type="submit">Activ</button></a>
                        @elseif($list->status==0)
                            <a href="{{url('admin/tax/status/1')}}/{{$list->id}}"><button class="btn btn-outline-secondary" type="submit">Deactiv</button></a>
                        @endif
                        </td>
                        <td class="text-center">
